...
BUILTIN_ITEMS = [
    # ── Agents ──
    {
        ...
        "author": "OpenPaper AI",
        "tags": ["export", "trade", "international", "b2b"],
        "downloads": 1280,
        "rating": 4.8,
        "permissions": ["memory:read", "memory:write", "agent:execute", "bus:publish", "bus:subscribe"],
        "dependencies": [],
        "config_schema": {
            "type": "object",
            "properties": {"target_markets": {"type": "array", "items": {"type": "string"}}},
        },
    ...
    },
    {
        ...
        "author": "OpenPaper AI",
        "tags": ["sales", "leads", "crm", "pipeline"],
        "downloads": 2450,
        "rating": 4.9,
        "permissions": ["memory:read", "memory:write", "agent:execute", "task:read", "task:write"],
        "dependencies": [],
        "config_schema": {"type": "object", "properties": {"daily_target": {"type": "integer"}}},
    ...
    },
    {
        ...
        "downloads": 3100,
        "rating": 4.7,
        "permissions": ["memory:read", "memory:write", "agent:execute", "bus:publish"],
        "dependencies": [],
        "config_schema": {},
    ...
    },
    {
        ...
        "downloads": 890,
        "rating": 4.5,
        "permissions": ["memory:read", "memory:write", "agent:execute"],
        "dependencies": [],
        "config_schema": {},
    ...
    },
    {
        ...
        "author": "OpenPaper AI",
        "tags": ["linkedin", "social", "networking", "leads"],
        "downloads": 1560,
        "rating": 4.6,
        "permissions": ["memory:read", "memory:write", "agent:execute", "network"],
        "dependencies": [],
        "config_schema": {},
    ...
    },
    {
        ...
        "author": "OpenPaper AI",
        "tags": ["email", "outreach", "campaign", "marketing"],
        "downloads": 2100,
        "rating": 4.4,
        "permissions": ["memory:read", "memory:write", "agent:execute", "task:read", "task:write"],
        "dependencies": [],
    ...
    },
    {
        ...
        "author": "OpenPaper AI",
        "tags": ["support", "customer", "ticket", "service"],
        "downloads": 1780,
        "rating": 4.7,
        "permissions": ["memory:read", "memory:write", "agent:execute", "task:read", "task:write", "bus:subscribe"],
        "dependencies": [],
        "config_schema": {},
    ...
    },
    {
        ...
        "author": "OpenPaper AI",
        "tags": ["sales", "outreach", "email", "pipeline"],
        "downloads": 1200,
        "rating": 4.6,
        "permissions": ["memory:read", "agent:execute", "task:read", "task:write"],
        "dependencies": ["agent-sales", "agent-email"],
        "config_schema": {},
    ...
    },
    {
        ...
        "rating": 4.5,
        "permissions": ["memory:read", "memory:write", "agent:execute", "bus:publish"],
        "dependencies": ["agent-research", "agent-seo"],
        "config_schema": {},
    ...
    },
    {
        ...
        "author": "OpenPaper AI",
        "tags": ["pdf", "report", "document", "template"],
        "downloads": 1800,
        "rating": 4.7,
        "permissions": [],
        "dependencies": [],
    ...
    },
    {
        ...
        "author": "OpenPaper AI",
        "tags": ["analysis", "data", "statistics", "visualization"],
        "downloads": 1100,
        "rating": 4.4,
        "permissions": ["memory:read"],
        "dependencies": [],
    ...
    # ── Providers ──
    {
        ...
        "author": "OpenPaper AI",
        "tags": ["deepseek", "china", "llm", "chat"],
        "downloads": 890,
        "rating": 4.3,
        "permissions": ["network", "provider:read", "provider:write"],
        "dependencies": [],
        "config_schema": {},
    ...
    },
    {
        ...
        "author": "OpenPaper AI",
        "tags": ["openrouter", "multi-provider", "llm", "unified"],
        "downloads": 2100,
        "rating": 4.8,
        "permissions": ["network", "provider:read", "provider:write"],
        "dependencies": [],
...
async def list_marketplace(
    ...
    result = await db.execute(
        select(InstalledMarketplaceItem).where(InstalledMarketplaceItem.user_id == current_user.id)
    )
...
async def install_item(
    ...
    if ptype:
        ...
        try:
            registry.register_manifest(item["id"], manifest)
...
async def uninstall_item(
    ...
    registry = get_plugin_registry()
    registry.unregister_manifest(item_id)
